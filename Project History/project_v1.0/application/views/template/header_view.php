				...
				<ul class="srt-menu" id="menu-main-navigation">
					...
					<?php if ($this->session->userdata('admin_lvl')) { ?>	
						<li><a href="#"><?php echo $this->lang->line('menu_lib'); ?></a>
							<ul>
								<li><a href="<?php echo base_url(); ?>index.php/warehouse/library"><?php echo $this->lang->line('menu_lib_products'); ?></a></li>							
								<li><a href="<?php echo base_url(); ?>index.php/warehouse/packing"><?php echo $this->lang->line('menu_lib_packing'); ?></a></li>
					...
					<?php if ($this->session->userdata('admin_lvl')) { ?>	
						<li><a href="#"><?php echo $this->lang->line('menu_users'); ?></a>
							<ul>
								<li><a href="<?php echo base_url(); ?>index.php/users/manage"><?php echo $this->lang->line('menu_manage'); ?></a></li>
							</ul>
						</li>
